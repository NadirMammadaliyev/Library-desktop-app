...
public class NewAuthorFrame extends javax.swing.JFrame {
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "Author has been succsessfully added!");

            this.dispose();
        } catch (Exception ex) {
            ex.printStackTrace();
            JOptionPane.showConfirmDialog(null, "Author has not been succsessfully added!", "Error", ERROR);
        }
