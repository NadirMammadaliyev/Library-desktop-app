...
public class NewUserFrame extends javax.swing.JFrame  {
    ...
    private void saveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveBtnActionPerformed
        try {
            ...
            JOptionPane.showMessageDialog(null, "User has been succsessfully added!");
            
            this.dispose();
        } catch (Exception ex) {
            ex.printStackTrace();
             JOptionPane.showConfirmDialog(null, "User has not been succsessfully added!", "Error", ERROR);
        }
